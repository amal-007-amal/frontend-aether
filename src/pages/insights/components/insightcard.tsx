...
export function InsightCard({ insighttext, insights }: InsightCardProps) {
    ...
    return (
        <div className="w-full mt-4 rounded-e-xl border-l border-l-fuchsia-500 bg-white dark:border-stone-700 dark:bg-transparent">
                    ...
                    <AccordionTrigger className="px-4 text-left text-sm font-medium">
                        <div className="space-y-4">
                            <div className="text-sm flex items-center gap-3">
                                <p className="font-medium whitespace-nowrap flex gap-3 items-center"><Info className="text-gray-600 dark:text-white h-4"/>Input Query:</p>
