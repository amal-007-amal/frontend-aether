...
export default function Header() {
    ...
    return (
        <header className="bg-white shadow-sm text-white p-4 border-b border-b-gray-300 flex justify-between items-center">
            <h2 className="font-light flex text-black text-xl items-center">
                A<span className="text-purple-500 font-normal">ether</span>&nbsp;Hub&nbsp;
